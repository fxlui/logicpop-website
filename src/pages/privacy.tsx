...
const Home: NextPage = () => {
  return (
    <div className="w-full flex justify-center items-center">
      <Head>
        <title>Medician Privacy Policy - logicpop</title>
        <meta
          name="description"
          content="This webpage contains the Privacy Policy for Medician"
        />
      ...
      <div className="fixed top-5 right-5">
        <Link href="/">
          <a className="inline-flex justify-center p-3 text-white hover:text-black transition-colors bg-primary rounded-lg hover:bg-bg-card focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500">
            Back to Home
          </a>
        </Link>
      </div>

      <div className="flex flex-col max-w-2xl py-20">
        <h1 className="font-semibold text-2xl mb-2">Privacy Policy</h1>
        <p>
          logicpop built the Medician app as a Free app. This SERVICE is
          provided by logicpop at no cost and is intended for use as is. This
          ...
          Conditions, which is accessible at Medician unless otherwise defined
        ...
        <p>
          ...
          <ul>
            <li>
              <a href="https://expo.io/privacy">* Expo Policies</a>
            </li>
            <li>
        ...
        <h2 className="font-semibold text-xl my-2">Log Data</h2>
        <p>
        ...
        <h2 className="font-semibold text-xl my-2">Cookies</h2>
        <p>
        ...
        <h2 className="font-semibold text-xl my-2">Service Providers</h2>
        <p>
        ...
        <h2 className="font-semibold text-xl my-2">Security</h2>
        <p>
        ...
        <h2 className="font-semibold text-xl my-2">Links to Other Sites</h2>
        <p>
        ...
        <h2 className="font-semibold text-xl my-2">Children’s Privacy</h2>
        <p>
        ...
        <p>
          ...
          not hesitate to contact us at privacy@logicpop.com.au.
        </p>
      </div>
    </div>
  )
